...
public class WaveView extends BaseRelativeLayout {
    ...
    private int waveHeight = 0;// 波浪的最高度def 20,现在初重设为0
    ...
    private void initView(){
        mPaint = new Paint();
        mPaint.setColor(context.getResources().getColor(R.color.c2));
...
//        baseLine = height/2;
    ...
    //高度的占比
    public void setBaseLine(float percent){
        int newHeight = (int) MathUtil.multiplyF(height , percent , 15);
        baseLine = height - newHeight;
//        ILog.e("setBaseLine:: " + "height: " + height + "     percent: " + percent + "   baseLine: " + baseLine);
